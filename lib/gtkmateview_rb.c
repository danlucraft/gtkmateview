...
static VALUE rb_gtk_mate_scope_compare(VALUE self, VALUE a, VALUE b) {
    // Method#type_checks
    // Method#argument_type_conversions
    GtkMateScope* _c_a;
    _c_a = _GTK_MATE_SCOPE_SELF(a);
    GtkMateScope* _c_b;
    _c_b = _GTK_MATE_SCOPE_SELF(b);
    // Method#body
    
    int _c_return;
    _c_return = gtk_mate_scope_compare(_c_a, _c_b);
    // Method#return_type_conversion
    VALUE _rb_return; 
    _rb_return = INT2FIX(_c_return);
    return _rb_return;
...
static VALUE rb_gtk_mate_grammar_get_file_types(VALUE self) {
    ...
    VALUE _rb_return; 
              ...
              long val25;
              for(val25 = 0; val25 < _rb_return__length; val25++) {
                  rb_ary_store(_rb_return, val25, rb_str_new2(_c_return[val25]));
//                g_free(_c_return[val25]);
              }
          }
...
static VALUE rb_gtk_mate_grammar_set_file_types(VALUE self, VALUE file_types) {
    ...
    char** _c_file_types;
          ...
          long val26;
          for(val26 = 0; val26 < _c_file_types__length; val26++) {
             *(_c_file_types+val26) = RSTRING_PTR(rb_ary_entry(file_types, (long) val26));
          }
...
static VALUE rb_gtk_mate_grammar_set_patterns(VALUE self, VALUE patterns) {
    ...
    GeeArrayList* _c_patterns;
        // ArrayListType#ruby_to_c(:before, "patterns", "_c_patterns")
    int len_val32 = RARRAY_LEN(patterns);
    _c_patterns = gee_array_list_new (GTK_MATE_TYPE_PATTERN, ((GBoxedCopyFunc) (g_object_ref)), g_object_unref, g_direct_equal);
    {
        gint i;
        i = 0;
...
static VALUE rb_gtk_mate_grammar_get_repository(VALUE self) {
    ...
    if (v == NULL) {
        ...
        for (it_val33 = 0; it_val33 < gee_collection_get_size (GEE_COLLECTION (v)); it_val33 = it_val33 + 1) {
            GtkMatePattern* i_val34;
            i_val34 =  (gee_list_get (GEE_LIST (v), it_val33));
            VALUE rb_ival34;
            rb_ival34 = GOBJ2RVAL(i_val34);
            rb_ary_store (rb_v, it_val33, rb_ival34);
        }
    }
...
static VALUE rb_gtk_mate_grammar_set_repository(VALUE self, VALUE repository) {
    ...
    int len_val36 = RARRAY_LEN(_rb_value);
...
static VALUE rb_gtk_mate_buffer_get_bundles(VALUE self) {
    ...
    if (_c_return == NULL) {
        ...
        int it_val37;
        _rb_return = rb_ary_new2((long) gee_collection_get_size (GEE_COLLECTION (_c_return)));
        for (it_val37 = 0; it_val37 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val37 = it_val37 + 1) {
            GtkMateBundle* i_val38;
            i_val38 =  (gee_list_get (GEE_LIST (_c_return), it_val37));
            VALUE rb_ival38;
            rb_ival38 = GOBJ2RVAL(i_val38);
            rb_ary_store (_rb_return, it_val37, rb_ival38);
        }
    }
...
static VALUE rb_gtk_mate_buffer_set_bundles(VALUE self, VALUE bundles) {
    ...
    int len_val39 = RARRAY_LEN(bundles);
...
static VALUE rb_gtk_mate_buffer_set_themes(VALUE self, VALUE themes) {
    ...
    GeeArrayList* _c_themes;
        // ArrayListType#ruby_to_c(:before, "themes", "_c_themes")
    int len_val42 = RARRAY_LEN(themes);
    _c_themes = gee_array_list_new (GTK_MATE_TYPE_THEME, ((GBoxedCopyFunc) (g_object_ref)), g_object_unref, g_direct_equal);
    {
        gint i;
        i = 0;
...
static VALUE rb_gtk_mate_parser_close_scope(VALUE self, VALUE scanner, VALUE line_ix, VALUE m) {
    GtkMateParser* gtk_mate_parser = RVAL2GOBJ(self);
    // Method#type_checks
    ...
    gtk_mate_parser_close_scope(gtk_mate_parser, _c_scanner, _c_line_ix, _c_m);
    // Method#return_type_conversion
    return Qnil;
}

static VALUE rb_gtk_mate_parser_open_scope(VALUE self, VALUE scanner, VALUE line_ix, VALUE length, VALUE m) {
    GtkMateParser* gtk_mate_parser = RVAL2GOBJ(self);
    // Method#type_checks
    if (TYPE(line_ix) != T_FIXNUM) {
        VALUE rb_arg_error = rb_eval_string("ArgumentError");
    ...
    gtk_mate_parser_open_scope(gtk_mate_parser, _c_scanner, _c_line_ix, _c_length, _c_m);
    // Method#return_type_conversion
    return Qnil;
}

static VALUE rb_gtk_mate_parser_single_scope(VALUE self, VALUE scanner, VALUE line_ix, VALUE length, VALUE m) {
    GtkMateParser* gtk_mate_parser = RVAL2GOBJ(self);
    // Method#type_checks
    if (TYPE(line_ix) != T_FIXNUM) {
        VALUE rb_arg_error = rb_eval_string("ArgumentError");
    ...
    gtk_mate_parser_single_scope(gtk_mate_parser, _c_scanner, _c_line_ix, _c_length, _c_m);
    // Method#return_type_conversion
    return Qnil;
}
...
static VALUE rb_gtk_mate_scanner_set_cached_markers(VALUE self, VALUE cached_markers) {
    ...
    int len_val45 = RARRAY_LEN(cached_markers);
...
static VALUE rb_range_set_get_ranges(VALUE self) {
    ...
    if (_c_return == NULL) {
        ...
        int it_val54;
        _rb_return = rb_ary_new2((long) gee_collection_get_size (GEE_COLLECTION (_c_return)));
        for (it_val54 = 0; it_val54 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val54 = it_val54 + 1) {
            RangeSetRange* i_val55;
            i_val55 =  (gee_list_get (GEE_LIST (_c_return), it_val54));
            VALUE rb_ival55;
            rb_ival55 = GOBJ2RVAL(i_val55);
            rb_ary_store (_rb_return, it_val54, rb_ival55);
        }
    }
...
static VALUE rb_range_set_set_ranges(VALUE self, VALUE ranges) {
    ...
    int len_val56 = RARRAY_LEN(ranges);
...
void Init_gtkmateview_rb() {
    ...
    rb_define_method(rbc_gtk_mate_parser, "close_scope", rb_gtk_mate_parser_close_scope, 3);
    rb_define_method(rbc_gtk_mate_parser, "open_scope", rb_gtk_mate_parser_open_scope, 4);
    rb_define_method(rbc_gtk_mate_parser, "single_scope", rb_gtk_mate_parser_single_scope, 4);
