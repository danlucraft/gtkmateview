...
static VALUE rb_gtk_mate_bundle_dirs(VALUE self) {
    ...
    for (it_val1 = 0; it_val1 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val1 = it_val1 + 1) {
        ...
        VALUE rb_ival2 = rb_str_new2(i_val2);
...
static VALUE rb_gtk_mate_bundle_dirs_rb(VALUE self) {
    ...
    VALUE _rb_return;
          ...
          long val3;
          for(val3 = 0; val3 < _rb_return__length; val3++) {
              rb_ary_store(_rb_return, val3, rb_str_new2(_c_return[val3]));
              g_free(_c_return[val3]);
          }
...
static VALUE rb_gtk_mate_pattern_set_all_patterns(VALUE self, VALUE all_patterns) {
    ...
    gtk_mate_pattern->all_patterns = _c_all_patterns;
...
static VALUE rb_gtk_mate_double_pattern_get_patterns(VALUE self) {
    ...
    for (it_val7 = 0; it_val7 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val7 = it_val7 + 1) {
        GtkMatePattern* i_val8;
        i_val8 =  (gee_list_get (GEE_LIST (_c_return), it_val7));
        VALUE rb_ival8 = GOBJ2RVAL(i_val8);
...
static VALUE rb_gtk_mate_double_pattern_set_patterns(VALUE self, VALUE patterns) {
    ...
    GeeArrayList* _c_patterns;
        int len_val9 = RARRAY_LEN(patterns);
...
static VALUE rb_gtk_mate_grammar_get_file_types(VALUE self) {
    ...
    VALUE _rb_return;
              _rb_return = rb_ary_new2(_rb_return__length);
          long val10;
          for(val10 = 0; val10 < _rb_return__length; val10++) {
              rb_ary_store(_rb_return, val10, rb_str_new2(_c_return[val10]));
              g_free(_c_return[val10]);
          }
...
static VALUE rb_gtk_mate_grammar_set_file_types(VALUE self, VALUE file_types) {
    ...
    char** _c_file_types;
              int _c_file_types__length = RARRAY_LEN(file_types);
          _c_file_types = malloc(_c_file_types__length*sizeof(char*));
          long val11;
          for(val11 = 0; val11 < _c_file_types__length; val11++) {
             *(_c_file_types+val11) = RSTRING_PTR(rb_ary_entry(file_types, (long) val11));
          }

    gtk_mate_grammar->file_types = _c_file_types, _c_file_types__length;
...
static VALUE rb_gtk_mate_grammar_get_patterns(VALUE self) {
    ...
    for (it_val12 = 0; it_val12 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val12 = it_val12 + 1) {
        ...
        VALUE rb_ival13 = GOBJ2RVAL(i_val13);
...
static VALUE rb_gtk_mate_grammar_all_patterns(VALUE self) {
    GtkMateGrammar* gtk_mate_grammar = RVAL2GOBJ(self);


    
    GeeArrayList* _c_return;
    _c_return = gtk_mate_grammar_all_patterns(gtk_mate_grammar);
    VALUE _rb_return;
        int it_val15;
    _rb_return = rb_ary_new2((long) gee_collection_get_size (GEE_COLLECTION (_c_return)));
    for (it_val15 = 0; it_val15 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val15 = it_val15 + 1) {
        ...
        VALUE rb_ival16 = GOBJ2RVAL(i_val16);
...
static VALUE rb_gtk_mate_buffer_set_bundles(VALUE self, VALUE bundles) {
    ...
    GeeArrayList* _c_bundles;
        int len_val20 = RARRAY_LEN(bundles);
    ...
    gtk_mate_buffer->bundles = _c_bundles;
...
static VALUE rb_gtk_mate_buffer_set_themes(VALUE self, VALUE themes) {
    ...
    GeeArrayList* _c_themes;
        int len_val23 = RARRAY_LEN(themes);
    ...
    gtk_mate_buffer->themes = _c_themes;

    return Qnil;
}

static VALUE rb_gtk_mate_buffer_all_bundles(VALUE self) {
    GtkMateBuffer* gtk_mate_buffer = RVAL2GOBJ(self);


    
    GeeArrayList* _c_return;
    _c_return = gtk_mate_buffer_all_bundles(gtk_mate_buffer);
    VALUE _rb_return;
        int it_val24;
    _rb_return = rb_ary_new2((long) gee_collection_get_size (GEE_COLLECTION (_c_return)));
    for (it_val24 = 0; it_val24 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val24 = it_val24 + 1) {
        GtkMateBundle* i_val25;
        i_val25 =  (gee_list_get (GEE_LIST (_c_return), it_val24));
        VALUE rb_ival25 = GOBJ2RVAL(i_val25);
...
static VALUE rb_gtk_mate_buffer_all_themes(VALUE self) {
    GtkMateBuffer* gtk_mate_buffer = RVAL2GOBJ(self);


    
    GeeArrayList* _c_return;
    _c_return = gtk_mate_buffer_all_themes(gtk_mate_buffer);
    VALUE _rb_return;
        int it_val26;
    _rb_return = rb_ary_new2((long) gee_collection_get_size (GEE_COLLECTION (_c_return)));
    for (it_val26 = 0; it_val26 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val26 = it_val26 + 1) {
        GtkMateTheme* i_val27;
        i_val27 =  (gee_list_get (GEE_LIST (_c_return), it_val26));
        VALUE rb_ival27 = GOBJ2RVAL(i_val27);
...
static VALUE rb_gtk_mate_bundle_get_grammars(VALUE self) {
    ...
    for (it_val28 = 0; it_val28 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val28 = it_val28 + 1) {
        ...
        VALUE rb_ival29 = GOBJ2RVAL(i_val29);
...
static VALUE rb_gtk_mate_bundle_all_grammars(VALUE self) {
    GtkMateBundle* gtk_mate_bundle = RVAL2GOBJ(self);


    
    GeeArrayList* _c_return;
    _c_return = gtk_mate_bundle_all_grammars(gtk_mate_bundle);
    VALUE _rb_return;
        int it_val31;
    _rb_return = rb_ary_new2((long) gee_collection_get_size (GEE_COLLECTION (_c_return)));
    for (it_val31 = 0; it_val31 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val31 = it_val31 + 1) {
        GtkMateGrammar* i_val32;
        i_val32 =  (gee_list_get (GEE_LIST (_c_return), it_val31));
        VALUE rb_ival32 = GOBJ2RVAL(i_val32);
...
static VALUE rb_plist_array_get_array(VALUE self) {
    ...
    for (it_val33 = 0; it_val33 < gee_collection_get_size (GEE_COLLECTION (_c_return)); it_val33 = it_val33 + 1) {
        ...
        VALUE rb_ival34 = GOBJ2RVAL(i_val34);
...
static VALUE rb_plist_array_set_array(VALUE self, VALUE array) {
    ...
    GeeArrayList* _c_array;
        int len_val35 = RARRAY_LEN(array);
...
void Init_gtkmateview_rb() {
    ...
    rb_define_method(rbc_gtk_mate_buffer, "bundles", rb_gtk_mate_buffer_get_bundles, 0);
    rb_define_method(rbc_gtk_mate_buffer, "bundles=", rb_gtk_mate_buffer_set_bundles, 1);
    rb_define_method(rbc_gtk_mate_buffer, "themes", rb_gtk_mate_buffer_get_themes, 0);
    rb_define_method(rbc_gtk_mate_buffer, "themes=", rb_gtk_mate_buffer_set_themes, 1);
    rb_define_method(rbc_gtk_mate_buffer, "all_bundles", rb_gtk_mate_buffer_all_bundles, 0);
    rb_define_method(rbc_gtk_mate_buffer, "all_themes", rb_gtk_mate_buffer_all_themes, 0);
    ...
    rb_define_method(rbc_gtk_mate_bundle, "all_grammars", rb_gtk_mate_bundle_all_grammars, 0);
    ...
    rb_define_method(rbc_gtk_mate_grammar, "all_patterns", rb_gtk_mate_grammar_all_patterns, 0);
    ...
    rb_define_method(rbc_gtk_mate_pattern, "all_patterns", rb_gtk_mate_pattern_get_all_patterns, 0);
    rb_define_method(rbc_gtk_mate_pattern, "all_patterns=", rb_gtk_mate_pattern_set_all_patterns, 1);
