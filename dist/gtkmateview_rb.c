...
static VALUE rb_plist_array_set_array(VALUE self, VALUE array) {
    ...
    int len_val67 = RARRAY_LEN(array);
...
static VALUE rb_plist_dict_set_map(VALUE self, VALUE map) {
    ...
    int len_val68 = RARRAY_LEN(rb_keys);
    {
        gint i;
        i = 0;
        for (; i < len_val68; i++) {
...
static VALUE rb_plist_dict_keys(VALUE self) {
    ...
    VALUE _rb_return; 
              ...
              _rb_return = rb_ary_new2(_rb_return__length);
              long val69;
              for(val69 = 0; val69 < _rb_return__length; val69++) {
                  rb_ary_store(_rb_return, val69, rb_str_new2(_c_return[val69]));
//                g_free(_c_return[val69]);
              }
          }
...
static VALUE rb_range_set_set_ranges(VALUE self, VALUE ranges) {
    ...
    int len_val72 = RARRAY_LEN(ranges);
